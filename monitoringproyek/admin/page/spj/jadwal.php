...
<?php include 'functions.php';?><div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
    ...
    <h4>Data SPJ</h4>
                ...
                $proyek=mysqli_fetch_array($tampil1);
                    ...
                    <td>
                        ...
                        <a onclick="return confirm ('Apakah anda yakin menghapus jadwal ini?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus SPJ" href="?page=page/spj/hapus&id=<?= $data['id_spj']; ?>"><span class="fa fa-trash-o" style="font-size:15px;"></a></div></center></td></tr>
