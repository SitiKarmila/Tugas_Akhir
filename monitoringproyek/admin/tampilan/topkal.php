	<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<?php if($_GET['level']=='Pengawas'){}else{?>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="../img/<?php if($_GET['level']=='Admin'){ echo"Admin";}else{ echo"pengawas";}?>/<?= $_GET['gambar']?>" style="width: 50px;height: 50px;" alt=""> </span> 
									<div class="user-name">
										<p><?= $_GET['nama']?></p>
										<span><?php if($_GET['level']=='Admin'){ echo"Administrator";}else{ echo"Pengawas";}?></span>
									</div>
							...
							<ul class="dropdown-menu drp-mnu">
								<li> <a href="?page=page/<?php if($_GET['level']=='Admin'){ echo"admin";}else{ echo"pengawas";}?>/edit&id=<?= $_GET['id']?>"><i class="fa fa-suitcase"></i> Profile</a> </li> 
